...
const columna = [
    { id: 'id', numeric: false, disablePadding: true, label: 'Identificador' },
    { id: 'nombre', numeric: false, disablePadding: false, label: 'Nombre' },
    { id: 'apellido', numeric: false, disablePadding: false, label: 'Apellido' },
    { id: 'equipo', numeric: false, disablePadding: false, label: 'Equipo' },
    { id: 'edad', numeric: true, disablePadding: false, label: 'Edad' },
    { id: 'url', numeric: false, disablePadding: false, label: 'Wikipedia' },
];
